...
cut first, then the arrival window, never the spine. Live measurements exist only in the last
...
## M4 · Network map — Thu, if M3 lands before evening
...
**Done when** the Oslo tunnel shows as a coloured segment on a weekday afternoon.
